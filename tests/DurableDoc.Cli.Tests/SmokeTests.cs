...
""");
        ...
        var dashboardJs = File.ReadAllText(Path.Combine(fixture.OutputDirectory, "dashboard.js"));
        ...
        Assert.Contains("source-panel-link disabled", dashboard, StringComparison.Ordinal);
        ...
        Assert.Contains(".source-panel-link {", dashboardCss, StringComparison.Ordinal);
        Assert.Contains(".viewer-back-link {", dashboardCss, StringComparison.Ordinal);
        Assert.Contains(".source-panel {\n  border-top: 1px solid var(--line);\n  padding-top: 12px;", dashboardCss, StringComparison.Ordinal);
        Assert.Contains(".source-panel-link {\n  display: inline-flex;\n  align-items: center;\n  gap: 8px;\n  margin-top: 12px;", dashboardCss, StringComparison.Ordinal);
        Assert.Contains("align-items: stretch;", dashboardCss, StringComparison.Ordinal);
        Assert.Contains(".stage-actions {\n  display: flex;", dashboardCss, StringComparison.Ordinal);
        ...
        Assert.Contains("url.searchParams.set('orchestrator', orchestratorKey);", dashboardJs, StringComparison.Ordinal);
        Assert.Contains("url.searchParams.set('mode', artifact.mode);", dashboardJs, StringComparison.Ordinal);
